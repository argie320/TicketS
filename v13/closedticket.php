...
if(isset($_POST['postComment'])){
    ...
    if(isset($MessageReplay)){
        ...
        $status =  $ticketReplay->postComment( $ticketNumber , $MessageReplay, $username);
				 //  $WticketReplay = new Workreplay( $ticketNumber ,  $username);
                 //  $Wstatus =  $WticketReplay->postComment( $ticketNumber , $MessageReplay, $username);
				           
    $ticket = new Ticketcloser();
    $ticketStatus = $ticket->closeTicketStatus($ticketNumber,$tlog);
    if($ticket->closeTicket($ticketNumber,$tlog)){
        echo "Sucess";
    }else{
        echo "Failed";
    }
