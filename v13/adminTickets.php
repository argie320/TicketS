     ...
     <div id="content">
             ...
             <!-- START OF NAVHeader-->
            	...
            	<ul>
   					...
   					<li><a href='myadmin.php'><span>Tickets</span></a></li>
               </ul>
            </div>
            <!-- END OF NAVBAR2 -->
           ...
           <!-- START OF NEW TICKET AND USER INFORMATION!! -->
            <div id="tickets">
            	<table style="margin-left:auto; margin-right:auto;">
                	<br />
            		<tr>
                    	<th id="opentickets" style="text-align:center">Tickets</th>
                    </tr>
                    <tr>
              ...
              <Table style="margin-left:auto; margin-right:auto; margin-top:20px">
                ...
                <form action="adminworkorder.php" method="post">
         ...
         <!--       <input type="submit" value="submit" name="postComment">
                <input type="submit" value="clear" onClick="return false">    -->
