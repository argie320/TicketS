...
if(isset($_POST['postComment'])){
    ...
    if(isset($MessageReplay)){
        ...
        if(isset($status)){
            ...
            switch($status){
                case 1:
                    Redirect::to( 5, 'ticket?id='.$ticketNumber.'' );
                    break;
                case 0:
            ...
            <div id="tickets">
                ...
                <table id="table2" style="margin-top:20px">
                    ...
                    <tr>
                        ...
                        <td>
                        	<select id="input2" name="department">
                            	<option value="0"><?php echo $department;?></option>
                    ...
                    <tr>
                        ...
                        <td>
                        	<select id="input2" name="helptopic">
                            	<option value="0"><?php echo $HelpTopic;?></option>
                    ...
                    <tr>
                        ...
                        <td>
                        	<select id="input2" name="slaplan">
                            	<option value="0" ><?php echo $SLAPlan;?></option>
                   ...
                   <tr>
                        ...
                        <td>
                        <label id="input2" disabled><?php echo $assignto;?></label>
              <!--          	<select id="input2" class="assignto" name="assignto">
                            	<option value="assign" disabled><?php echo $assignto; ?></option>
                                <?php echo $person; ?> -->
                            </select>
                        </td>
                   </tr>
                ...
                <form action="reopen.php" method="post">
   ...
   <div class="tab">
       ...
       <div class="content">
           ...
           paku
                    ...
                    <table id="table2" name="tb1" style="margin-top:15px">
